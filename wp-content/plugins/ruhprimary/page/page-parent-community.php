...
class Elementor_Ruh_Parent_Community extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        echo '<section class="mystery-readers " data-aos="fade-up"><div class="mystery-readers__container container">';
        ...
        echo '<section class="community-partnership " data-aos="fade-up"><div class="community-partnership__container container">';
        ...
        echo '<section class="coffee-connections" data-aos="fade-up" ><div class="coffee-connections__container container">';
